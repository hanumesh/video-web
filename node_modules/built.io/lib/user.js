...
* 1) When a session is persisted using <b>cookie</b>, authtoken would be extracted from it and a call to Built.io Backend would be made to fetch the whole user profile.</br>
...
* @memberof User
* @function getCurrentUser()|getSession()
