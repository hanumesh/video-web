...
*     message: 'Hello Built.io Backend'
*   });
* });
* @return {Presence}
*/
module.exports.setStatusMessage = set('state')
instanceMethodBuilder.define('setStatusMessage',2);
...
/**
* Gets a list of all whitelisted users
...
* .getPresence()
* .then(function(presence){
*   var whiteListedUsers = presence.getWhiteListUsers()
* });
* @return {Presence}
*/
...
instanceMethodBuilder.define('getWhiteListUsers',1);
/**
...
/**
* Adds a user in whitelist.
* @function addInWhitelist
* @param {String|Object} user Uid of the user to be whitelisted or SDK object
* @instance
* @memberof Presence
* @example
...
instanceMethodBuilder.define('addInWhitelist',2);

/**
* Removes a user from whitelist.
* @function removeFromWhitelist
* @param {String|Object} user Uid of the user to be removed from whitelisted or SDK object
* @instance
* @memberof Presence
* @example
* // User to be whitelisted
...
* .getCurrentUserPresence()
* .then(function(presence){
*   presence = presence.removeFromWhitelist(user)
* });
* @return {Presence}
*/
...
instanceMethodBuilder.define('removeFromWhitelist',2);
/**
