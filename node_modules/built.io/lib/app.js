...
@instance
@param {String} apiKey Accepts Application's API key which Built.io Backend Backend uses to identify each application.
...
* @example
* // 'blt5d4sample2633b' is a dummy Application API key
* var app = Built.App('blt5d4sample2633b').setHost('api.Built.io Backend'); 
* @return {App}
*/
/*
...
* var app = Built
* 					.App('blt5d4sample2633b')
*         	.setRtHost('realtime.Built.io Backend')
*         	.enableRealtime() 
* @return {App}
*/
...
* @return {object}
*/
module.exports.fetchLastActivities = function(app) {
  var entity = {
...
instanceMethodBuilder.define('fetchLastActivities',1);
